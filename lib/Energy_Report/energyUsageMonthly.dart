          ...
          child: ListView(
            ...
            children: <Widget>[
              Row(
                children: [
                  // homePage(context),
                  Text('Energy Usage Monthly',style: TextStyle(fontSize: 32),),
...
InkWell energyUsageMonthly(BuildContext context) {
  return InkWell(
    child: Text('Energy Usage Monthly'),
    onTap: () {
      Navigator.pushReplacementNamed(context, '/energyUsageMonthly');
    },
  );
}
